            ...
            if (imagemContainer) {
              ...
              (async () => {
                ...
                for (let i = 1; i <= totalPages; i++) {
                  ...
                  doc.text(`Página ${i} de ${totalPages}`, 200, pageHeight - 10, {
                    align: "right"
                  });
                }
                ...
                doc.text("Veja este e outros roteiros no nosso site:", 105, finalY, {
                  align: "center"
                });
                finalY += 6;

                doc.setTextColor(0, 0, 255);
                doc.textWithLink("www.queensberry.com.br", 105, finalY, {
                  url: "https://www.queensberry.com.br",
                  align: "center"
                });
                doc.setTextColor(0, 0, 0);
                finalY += 6;

                doc.text("Veja a versão ONLINE do folheto impresso:", 105, finalY, {
                  align: "center"
                });
                finalY += 6;
                doc.text("Folhetos", 105, finalY, {
                  align: "center"
                });
                finalY += 6;
                doc.text("Condições Gerais para Viagens Internacionais", 105, finalY, {
                  align: "center"
                });
                finalY += 10;

                doc.setFont(undefined, "bold");
                doc.text("ATENÇÃO - Preços Sujeitos a Disponibilidade e Alteração Sem Aviso Prévio", 105, finalY, {
                  align: "center"
                });
